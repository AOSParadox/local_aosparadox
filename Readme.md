...
How to sync ?
=============
- 1- Repo init the LA.BR.1.2.9-01710-8x16.0 CAF Tag
	- To do so, use this command "repo init -u git://codeaurora.org/platform/manifest.git -b release -m default_LA.BR.1.2.9-01710-8x16.0.xml"
