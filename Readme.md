...
How to sync ?
=============
- 1- Repo init the LA.BR.1.2.9-02510-8x09.0 CAF Tag
	- To do so, use this command "repo init -u git://codeaurora.org/platform/manifest.git -b release -m default_LA.BR.1.2.9-02510-8x09.0.xml"
